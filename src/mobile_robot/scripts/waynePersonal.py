...
class voltbot():
    ...
    def commandExecutioner(self,x, y, theta):
    	...
    	try:
        	execute_command_client = rospy.ServiceProxy('execute_command', ExecuteMotionPrimitive)
...
if __name__ == '__main__':
  ...
  #  	global robot
    	...
    	#command=[ [2,2,1],[2,3,1],[2,3,0],[3,3,0]]
	#command=[[1,2,1],[1,2,0],[1,2,3],[1,2,0]]
	#command=[[2,1,0],[2,1,0],[2,1,0],[2,1,3],[2,0,3]]
	command = [[1,0,0],[2,0,0]]#,[1,0,1],[1,0,1]]
	#command = [[3,3,1],[3,3,2],[2,3,2],[1,3,2],[0,3,2]]
