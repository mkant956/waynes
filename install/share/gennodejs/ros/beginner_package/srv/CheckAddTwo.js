...
class CheckAddTwoRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CheckAddTwoRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CheckAddTwoRequest
    let len;
    let data = new CheckAddTwoRequest(null);
  ...
  static datatype() {
    ...
    return 'beginner_package/CheckAddTwoRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CheckAddTwoRequest(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
...
class CheckAddTwoResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CheckAddTwoResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CheckAddTwoResponse
    let len;
    let data = new CheckAddTwoResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'beginner_package/CheckAddTwoResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CheckAddTwoResponse(null);
...
module.exports = {
  Request: CheckAddTwoRequest,
  Response: CheckAddTwoResponse,
  md5sum() { return '670e8ca138898ad7e5338b42a76db5c8'; },
  datatype() { return 'beginner_package/CheckAddTwo'; }
};
